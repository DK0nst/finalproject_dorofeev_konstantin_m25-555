        ...
        def wrapper(*args, **kwargs) -> Any:
            ...
            try:
                ...
                if args and len(args) > 0:
                    if 'user_id' in str(func.__code__.co_varnames[:func.__code__.co_argcount]):
                        user_id_index = list(func.__code__.co_varnames[:func.__code__.co_argcount]).index('user_id')
                ...
                elif args and len(args) > 1 and 'currency_code' in str(func.__code__.co_varnames):
                    currency_index = list(func.__code__.co_varnames[:func.__code__.co_argcount]).index('currency_code')
                ...
                elif args and len(args) > 2 and 'amount' in str(func.__code__.co_varnames):
                    amount_index = list(func.__code__.co_varnames[:func.__code__.co_argcount]).index('amount')
